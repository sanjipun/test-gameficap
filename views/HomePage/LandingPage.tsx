...
const LandingPage = () => {
  ...
  return (
    <div id="landing-page" className="bg-C4C4C4 bg-opacity-10">
      <section className="grid grid-cols-1 gap-10 md:grid-cols-2 max-w-1440 mx-auto px-5 sm:px-7 md:px-10 lg:px-20 py-36">
        <section>
          ...
          <button className="bg-94A2AB text-white px-10 py-3 mt-6 rounded-md">
